              ...
              <Reveal key={p.id} delay={i * 60}>
                <div className="group flex h-full min-h-[26rem] flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-elegant">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <h3 className="mt-2 line-clamp-2 min-h-[3.5rem] text-lg font-semibold leading-7 text-foreground">{L(p.title)}</h3>
                    <p className="mt-2 line-clamp-3 min-h-[3.75rem] flex-1 text-sm leading-5 text-muted-foreground">{L(p.description)}</p>
