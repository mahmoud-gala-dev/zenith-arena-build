    ...
    return {
      ...
      links: [
        ...
        ...((s.header_image || s.cover_image)
          ? [{ rel: "preload", as: "image", href: (s.header_image || s.cover_image) as string }]
          : []),
      ],
      scripts: [
...
function ServiceDetailPage() {
  ...
  const benefitIcons = [ShieldCheck, Award, Clock, Wrench, Users, Sparkles];
  const benefits = t.serviceDetail.benefitsList.map((b, i) => ({
