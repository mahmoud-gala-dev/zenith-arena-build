              ...
              <Reveal key={s.id} id={s.slug_en}>
                <div className={`grid items-center gap-10 lg:grid-cols-2 ${i % 2 === 1 ? "lg:[&>div:first-child]:order-2" : ""}`}>
                  ...
                  <div className="relative overflow-hidden rounded-3xl shadow-elegant">
                    ...
                    <div
                      className="aspect-[4/3] w-full items-center justify-center bg-gradient-to-br from-secondary via-secondary/60 to-primary/20"
                      style={{ display: s.cover_image ? "none" : "flex" }}
                      aria-hidden={!!s.cover_image}
                      role={s.cover_image ? undefined : "img"}
                      aria-label={s.cover_image ? undefined : alt}
                    >
