...
const PERMISSION_LABELS: Record<PermissionKey, { en: string; ar: string }> = {
  ...
  "blog.article.attachments": { en: "Manage article attachments", ar: "إدارة مرفقات المقالات" },
  "blog.guide.attachments": { en: "Manage guide attachments", ar: "إدارة مرفقات الأدلة" },
  "blog.case_study.attachments": { en: "Manage case study attachments", ar: "إدارة مرفقات دراسات الحالة" },
