...
export const blogConfig: CmsCollectionConfig = {
  ...
  columns: [{ key: "featured_image", label: "Image", type: "image" }, ...commonColumns, { key: "content_type", label: "Type" }, { key: "reading_time", label: "Read time" }],
  searchFields: ["title_en", "title_ar", "slug_en", "excerpt_en", "seo_keywords"],
  orderBy: "published_at",
  filters: [
    { key: "status", label: "Status", values: ["published", "draft", "archived"] },
    { key: "content_type", label: "Type", values: ["article", "guide", "case_study"] },
  ],
  initialValues: { slug_en: "", slug_ar: "", title_en: "", title_ar: "", excerpt_en: "", excerpt_ar: "", content_en: "", content_ar: "", featured_image: "", author_name: "Egytic Editorial Team", reading_time: 5, tags: "", content_type: "article", seo_title_en: "", seo_title_ar: "", seo_description_en: "", seo_description_ar: "", seo_keywords: "", og_image: "", status: "published", featured: false },
  fields: [
    ...bilingualTitleFields,
...
export const categoryConfigs: CmsCollectionConfig[] = [
  ...
  },
  {
    ...
    singular: "category",
    description: "Manage project category labels and ordering.",
    columns: categoryColumns,
    searchFields: ["title_en", "title_ar", "slug_en"],
    orderBy: "sort_order",
    orderAscending: true,
