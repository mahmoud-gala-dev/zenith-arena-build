...
export const translations = {
  en: {
    ...
    serviceDetail: {
      ...
      benefitsSub: "What we bring to every project, from kick-off to hand-over.",
      related: "Related services",
      relatedSub: "Complementary services that strengthen your project.",
      projects: "Selected past projects",
      projectsSub: "Real deliveries from our field team for this service.",
      viewAll: "View all projects",
      viewService: "View service",
      viewProject: "Project details",
      benefitsList: [
        { title: "Internationally certified quality", desc: "Products & systems compliant with FIFA, World Athletics and ITF." },
        { title: "15+ years of expertise", desc: "200+ delivered projects across Egypt, the Middle East and Africa." },
        { title: "On-time delivery", desc: "Binding schedule with weekly updates and delay guarantees." },
        { title: "Turnkey solution", desc: "Study, design, supply, installation and maintenance in-house." },
        { title: "Dedicated engineering team", desc: "Assigned project engineer + daily on-site supervision." },
        { title: "Warranty up to 8 years", desc: "On sports surfaces with a preventive maintenance plan." },
      ],
    },
    knowledgeList: {
      empty: "No articles yet.",
      searchPlaceholder: "Search articles, guides & case studies...",
      allCategories: "All categories",
      allTags: "All tags",
      allTypes: "All content",
      typeArticle: "Articles",
      typeGuide: "Guides",
      typeCaseStudy: "Case studies",
      sortNewest: "Newest",
      sortOldest: "Oldest",
  ...
  ar: {
    ...
    serviceDetail: {
      ...
      whatsapp: "واتساب",
      quote: "اطلب عرض سعر",
      notFound: "لم يتم العثور على الخدمة",
      faq: "الأسئلة الشائعة",
      benefits: "لماذا تختار هذه الخدمة",
      benefitsSub: "مزايا نقدمها في كل مشروع من البداية للتسليم.",
      related: "خدمات ذات صلة",
      relatedSub: "استكشف خدمات تكميلية تعزّز مشروعك.",
      projects: "أمثلة من مشاريعنا",
      projectsSub: "لقطات حقيقية من تنفيذنا لهذه الخدمة.",
      viewAll: "عرض كل المشاريع",
      viewService: "استعرض الخدمة",
      viewProject: "تفاصيل المشروع",
      benefitsList: [
        { title: "جودة معتمدة دوليًا", desc: "منتجات وأنظمة مطابقة لمعايير FIFA و World Athletics و ITF." },
        { title: "خبرة +15 سنة", desc: "أكثر من 200 مشروع منفَّذ في مصر والشرق الأوسط وأفريقيا." },
        { title: "تسليم في الموعد", desc: "جدول زمني ملزم مع تحديثات أسبوعية وضمانات تأخير." },
        { title: "حل تسليم مفتاح", desc: "دراسة، تصميم، توريد، تنفيذ، وصيانة من مصدر واحد." },
        { title: "فريق هندسي مقيم", desc: "مهندس مشروع مخصص + إشراف ميداني يومي." },
        { title: "ضمان يمتد حتى 8 سنوات", desc: "على الأسطح الرياضية مع خطة صيانة وقائية." },
      ],
    },
    knowledgeList: {
      empty: "لا يوجد محتوى بعد.",
      searchPlaceholder: "ابحث في المقالات والأدلة ودراسات الحالة...",
      allCategories: "كل الفئات",
      allTags: "كل الوسوم",
      allTypes: "كل الأنواع",
      typeArticle: "مقالات",
      typeGuide: "أدلة إرشادية",
      typeCaseStudy: "دراسات حالة",
      sortNewest: "الأحدث",
      sortOldest: "الأقدم",
      sortReadingTime: "زمن القراءة",
      sortTitle: "العنوان (أ→ي)",
      resultsCount: "{count} عنصر",
